...
import { LogOut, User, X, HomeIcon, Users, CreditCardIcon } from "lucide-react";
...
export function DashboardParentSidebar() {
  ...
  const isActiveRoute = (path: string) => {
    ...
    const fullPath = `/parent/${slug}${path === "/" ? "" : path}`;
